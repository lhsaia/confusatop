...
$page_title = "Importar técnico";
$css_filename = "home_redesign";
$aux_css = "arbitros_redesign";
$css_login = 'login';
$css_versao = date('h:i:s');
$_SESSION['jogadorTime'] = 5; 
...
if(isset($_SESSION['loggedin']) && $_SESSION['loggedin']==true){
    ...
    for($i = 0; $i < count($listaLigas);$i++){
        ...
        echo "<option value='{$listaLigas[$i][0]}' data-sexo='{$listaLigas[$i][2]}'>{$listaLigas[$i][1]}{$genderSuffix}</option>";
    }
    echo "</select></p>";
    ...
    echo "<p class='selecaodeligas'>Nacionalidade: <select id='selecaonacionalidade' class=' selecaodeligas comboPais editavel '>";
    ...
    echo '<main class="propostas-container narrow-container" style="padding-top: 80px; padding-bottom: 60px;">';
    echo '<div class="propostas-card">';
    echo "<p>Usuário sem permissão para inserir técnicos, por favor faça o login.</p>";
    echo '</div>';
    echo '</main>';
}
?>
