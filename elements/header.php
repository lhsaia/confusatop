...
if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true && isset($_SESSION['impersonated'])) {
    ...
    if($_SESSION['admin_status'] == '1' && $_SESSION['impersonated'] == false){
	  ...
	  $admin_btn = "<a class='nav-item' href='/admin/stop_impersonation.php' style='color: #fbbf24;'><span class='material-symbols-outlined' style='font-size:18px; vertical-align:middle;'>undo</span> Parar Impersonação</a>";
	} else {
      $admin_btn = "";
