...
$page_title = "Erro 404 - Página Não Encontrada - CONFUSA.top";
  ...
  <div class="error-container">
    <div class="error-card">
      <div class="error-image-wrapper">
        <img src="/errors/404.png" alt="Erro 404" class="error-image">
      </div>
      <div class="error-content">
        <div class="error-code">404</div>
        <h1 class="error-title">Página Não Encontrada</h1>
        <p class="error-description">O link que você acessou pode estar quebrado ou a página foi removida do sistema.</p>
