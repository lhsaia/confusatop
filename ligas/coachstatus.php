...
$id_time = (int)($info['idTime'] ?? 0);
$nome_time = $info['time'] ?? '';
$escudo_time = $info['escudoTime'] ?? 'shield.png';
$id_liga = (int)($info['idLiga'] ?? 0);
$nome_liga = $info['liga'] ?? '';
$logo_liga = $info['logoLiga'] ?? 'trophy.png';
$tier_liga = $info['tier'] ?? '';
$pais_time = (int)($info['paisTime'] ?? 0);
$nome_pais_time = $info['nomePaisTime'] ?? '';
$bandeira_pais_time = $info['bandeiraPaisTime'] ?? 'flag.png';
$dono_clube = (int)($info['donoClube'] ?? 0);
