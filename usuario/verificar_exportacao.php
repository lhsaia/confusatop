...
if(isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true){
    ...
    if($elencoMenor = $time->verificarElencoMenor($_SESSION['user_id'])){
    ...
    if($elencoMaior = $time->verificarElencoMaior($_SESSION['user_id'])){
    ...
    if($capitaoTime = $time->verificarCapitao($_SESSION['user_id'])){
    ...
    if($penaltisTime = $time->verificarPenaltis($_SESSION['user_id'])){
    ...
    if($goleirosTime = $time->verificarGoleiros($_SESSION['user_id'])){
    ...
    if($escalacaoTime = $time->verificarEscalacoes($_SESSION['user_id'])){
    ...
    if($aposentadosTime = $time->verificarAposentados($_SESSION['user_id'])){
    ...
    if($tecnicosTimes = $time->verificarTecnicos($_SESSION['user_id'])){
